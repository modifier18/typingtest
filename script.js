...
var wordNo=1,wordsSubmitted=0,wordsCorrect=0,timer=30,flag=0,factor=2,seconds,difficulty=1;
...
function limitColor(a,r ){
  a.classList.add('yellow');
  r.classList.remove('yellow');
}
